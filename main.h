...
int _printint(va_list types, char buffer[], int flags, int width,
		int precision, int size);
int _printbinary(va_list types, char buffer[], int flags, int width,
		int precision, int size);
int _printunsignednumber(va_list types, char buffer[], int flags, int width,
		int precision, int size);
...
int _writeunsgnd(int is_negative, int ind, char buffer[], int flags, int width,
		int precision, int size);
